...
function custom_theme_assets() {
    ...
    if (is_front_page()) {
        ...
        //if (is_page('89') {
            // about page
            wp_enqueue_style( 'about-style', THEME_ROOT.'/css/about.css', array(), filemtime(THEME_ROOT.'/css/about.css') );
        //} else {
            // ライブラリ関連ファイル
            ...
            wp_enqueue_script( 'detail-slider-script', THEME_ROOT.'/js/detail-slider.js', array(), filemtime(THEME_ROOT.'/js/detail-slider.js') );
            wp_enqueue_script( 'detail-popup-script', THEME_ROOT.'/js/detail-popup.js', array(), filemtime(THEME_ROOT.'/js/detail-popup.js') );
        //}
    }
}
